            ...
            <tr>
                ...
                <td>
                    <c:if test="${ user.status == 1 }">
                        ...
                        <button id="btn-delete-${ status.count }" data-code="${ user.id }" data-text="${ user.idPerson.name }" type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete"><i class="fas fa-trash"></i> Eliminar</button>
                    </c:if>
                    <c:if test="${ user.status == 0 }">
